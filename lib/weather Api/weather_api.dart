  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      builder: (context, snapshot) {
        ...
        final tomorrowHours = weather.forecast!.forecastday!.length > 1
            ? weather.forecast!.forecastday![1].hour!
            : [];
        final allHours = [...todayHours, ...tomorrowHours]; // Combine hours
        ...
        return Stack(
          children: [
            ...
            Positioned.fill(
              child: AnimatedBackground(condition: currentCondition),
            ),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.black.withOpacity(0.2), // overlay
